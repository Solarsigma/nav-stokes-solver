...
from boundary_conditions import set_common_boundary_conditions, set_nav_stokes_boundary_conditions
...
class NavStokesSolver:
    ...
    def set_boundary_conditions(self):
        ...
        set_nav_stokes_boundary_conditions(self.Q[-1], self.Q_init, self.grid)
